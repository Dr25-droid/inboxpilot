...
# Standard reply email (also used as default in main.py)
STANDARD_EMAIL = {
    "author": "Alice Smith <alice.smith@company.com>",
    "to": "Alex Rivera <alex@company.com>",
    "subject": "Quick question about API documentation",
    "email_thread": """Hi Alex,
...
examples_triage = [
    {"inputs": {"email_input": email_input_1}, "outputs": {"classification": triage_output_1}},
    {"inputs": {"email_input": email_input_2}, "outputs": {"classification": triage_output_2}},
    {"inputs": {"email_input": email_input_3}, "outputs": {"classification": triage_output_3}},
    {"inputs": {"email_input": email_input_4}, "outputs": {"classification": triage_output_4}},
    {"inputs": {"email_input": email_input_5}, "outputs": {"classification": triage_output_5}},
    {"inputs": {"email_input": email_input_6}, "outputs": {"classification": triage_output_6}},
    {"inputs": {"email_input": email_input_7}, "outputs": {"classification": triage_output_7}},
    {"inputs": {"email_input": email_input_8}, "outputs": {"classification": triage_output_8}},
    {"inputs": {"email_input": email_input_9}, "outputs": {"classification": triage_output_9}},
    {"inputs": {"email_input": email_input_10}, "outputs": {"classification": triage_output_10}},
    {"inputs": {"email_input": email_input_11}, "outputs": {"classification": triage_output_11}},
    {"inputs": {"email_input": email_input_12}, "outputs": {"classification": triage_output_12}},
    {"inputs": {"email_input": email_input_13}, "outputs": {"classification": triage_output_13}},
    {"inputs": {"email_input": email_input_14}, "outputs": {"classification": triage_output_14}},
    {"inputs": {"email_input": email_input_15}, "outputs": {"classification": triage_output_15}},
    {"inputs": {"email_input": email_input_16}, "outputs": {"classification": triage_output_16}},
]
...
expected_tool_calls = [
    ...
    [],
    [],
    ["check_calendar_availability", "schedule_meeting", "write_email", "done"],
    [],
    ["write_email", "done"],
    ["write_email", "done"],
    ["write_email", "done"],
    [],
    ["check_calendar_availability", "write_email", "done"],
    [],
    [],
    ["write_email", "done"],
    [],
