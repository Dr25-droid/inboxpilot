...
def get_background(user_name: str = None, user_role: str = None) -> str:
    """Return background string, reading from env vars if not provided."""
    name = user_name or os.getenv("USER_NAME", "the user")
    role = user_role or os.getenv("USER_ROLE", "a professional")
